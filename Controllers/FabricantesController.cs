...
namespace vexed.Controllers
{
    public class FabricantesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdFabricante,NomeFabricante")] Fabricante fabricante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdFabricante,NomeFabricante")] Fabricante fabricante)
        {
            if (ModelState.IsValid)
            {
